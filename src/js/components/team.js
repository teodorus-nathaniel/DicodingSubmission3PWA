export default function getTeamComponent({ crestUrl, name, website, email, founded, phone, address, id, liked }, idx) {
	return `
    <div class="col s12 m5 ${idx % 2 == 0 ? '' : 'offset-m1'}">
      <div class="card hoverable team" data-id="${id}">
        <div class="card-image">
          <a class="btn-floating hoverable halfway-fab waves-effect waves-light white like-button" data-id="${id}"><i class="material-icons red-text">favorite${liked
		? ''
		: '_border'}</i></a>
